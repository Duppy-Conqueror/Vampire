...
INVALID_DATE = ["Invalid date!", "Please use 'YYYY-mm-dd' as the date format and type a valid date."]
...
INVALID_TIME = ["Invalid time!", "Please use 'HH:MM' in 24-hour system as the time format."]
INVALID_INTERVAL = ["Invalid time interval!", "Please make sure the begin time is at least 1 minute before the end time."]
INVALID_CODE = ["Invalid venue code!", "Venue not found! Please check your venue code."]
